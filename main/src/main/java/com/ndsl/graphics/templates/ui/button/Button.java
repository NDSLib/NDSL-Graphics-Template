...
public class Button implements IDrawable {
    ...
    public void onDraw(Graphics graphics, Rect rect) {
        ...
        if(this.handler.isClicked()){onClick();}
    }
    ...
    protected void onClick(){for(ClickListener listener:listeners){listener.onClick(this);}}

    private void drawBackground(Graphics g, Rect r) {
